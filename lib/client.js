  ...
  factory: (require) => {
    ...
    function apply(ctx) {
      ctx.effect(function* () {
        ...
        var state = { sessionId: undefined, open: false, busy: false, phase: "idle", original: "", result: "", error: "", request: 0, lastDraft: "", inputActions: null, timerDisposer: null, controller: null, abortTimer: null, listeners: new Set() };
        ...
        function start() {
          ...
          var reqOpts = { method: "POST", headers: { "content-type": "application/json" }, body: JSON.stringify({ text: draft }) };
