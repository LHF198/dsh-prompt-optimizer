...
window.__ModuleLoader__.load({
  id: "@joe0001/dsh-prompt-optimizer",
  factory: (require) => {
    var module = { exports: {} };
    ...
    var name = "@joe0001/dsh-prompt-optimizer";
    ...
    var CSS =
      ...
      ".prompt-optimizer-select{border:1px solid var(--dsw-alias-border-l1,rgba(128,128,128,.4));background:var(--dsw-alias-bg-layer-1,var(--dsw-alias-bg-overlay,#fff));color:var(--dsw-alias-label-primary,#1f2328);border-radius:6px;padding:2px 4px;font-size:11px;max-width:74px}" +
      ".prompt-optimizer-select:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#3b82f6)}" +
      ".prompt-optimizer-icon-btn,.prompt-optimizer-header-action{display:inline-flex;align-items:center;justify-content:center;border:1px solid var(--dsw-alias-border-l1,rgba(128,128,128,.4));background:var(--dsw-alias-bg-layer-1,var(--dsw-alias-bg-overlay,#fff));color:var(--dsw-alias-label-primary,#1f2328);border-radius:6px;padding:4px;cursor:pointer;line-height:0}" +
      ".prompt-optimizer-icon-btn:hover:not(:disabled),.prompt-optimizer-header-action:hover{filter:brightness(1.04)}" +
      ".prompt-optimizer-icon-btn:focus-visible,.prompt-optimizer-header-action:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#3b82f6);outline-offset:1px}" +
      ".prompt-optimizer-icon-btn:disabled{opacity:.45;cursor:not-allowed}" +
      ".prompt-optimizer-icon{display:block}" +
    ...
    function apply(ctx) {
      ctx.effect(function* () {
        ...
        function Sparkles(props) {
          return createElement("svg", { className: "prompt-optimizer-icon", width: 14, height: 14, viewBox: "0 0 24 24", fill: "currentColor", "aria-hidden": "true" },
            createElement("path", { d: "M12 3l1.9 4.1L18 9l-4.1 1.9L12 15l-1.9-4.1L6 9l4.1-1.9z" }),
            createElement("path", { d: "M18.5 13l.9 2.1 2.1.9-2.1.9-.9 2.1-.9-2.1-2.1-.9 2.1-.9z" }));
        }
        function CancelIcon() {
          return createElement("svg", { className: "prompt-optimizer-icon", width: 14, height: 14, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2.2, strokeLinecap: "round", "aria-hidden": "true" },
        ...
        function Button(p) {
          ...
          return createElement("div", { className: "prompt-optimizer-control" },
            ...
            createElement("button", {
              ...
              className: "prompt-optimizer-icon-btn",
              "aria-label": running ? t("button.cancel") : t("desc"),
              "aria-live": "polite",
              title: disabled ? t("empty.hint") : running ? t("button.cancel") : t("desc")
            }, running ? createElement(CancelIcon, null) : createElement(Sparkles, null)),
            state.lastAdopt ? createElement("button", { type: "button", className: "prompt-optimizer-icon-btn", onClick: undo, "aria-label": "撤回", title: "撤回" },
              createElement("svg", { className: "prompt-optimizer-icon", width: 14, height: 14, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2.2, strokeLinecap: "round", "aria-hidden": "true" },
                createElement("path", { d: "M3 12a9 9 0 1 0 3-6.7L3 8" }),
            ...
            state.error ? createElement("button", { type: "button", className: "prompt-optimizer-icon-btn", onClick: start, "aria-label": "重试", title: "重试" },
              createElement("svg", { className: "prompt-optimizer-icon", width: 14, height: 14, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2.2, strokeLinecap: "round", "aria-hidden": "true" },
                createElement("path", { d: "M20 11a8 8 0 1 0-2.3 5.7" }),
        ...
        yield slots.inject("conversation.input.right", function () {
          return slots.register({ name: "conversation.input.right", id: "prompt-optimizer-button", order: 50, label: function () { return t("desc"); } }, guarded(Button, t("render.error")));
        });
